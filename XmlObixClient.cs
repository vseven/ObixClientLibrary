...
namespace ObixClientLibrary
{
    ...
    /// </summary>
    public class XmlObixClient : ObixClient
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlObixClient"/> class for oBIX XML over HTTP.
        /// </summary>
                /// <param name="ObixLobbyUri">Obix lobby URI.</param>
        public XmlObixClient(Uri ObixLobbyUri, string userName = null, string password = null, int authtype = 3)
            : base(ObixLobbyUri)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlObixClient"/> class for oBIX XML over HTTP, with the provided signUp Uri.
        /// </summary>
        ...
        private ObixResult ParseAboutContract()
        {
            ...
            ObixResult<XElement> data = ReadUriXml(AboutUri);
            ...
            ObixAbout about = ObixAbout.FromXElement(data.Result);
            if (about == null)
            {
                return ErrorStack.Push(this.GetType(), ObixResult.kObixClientXMLParseError,
        ...
        public ObixResult<XElement> ReadUriXml(Uri uri)
        {
            ...
            ObixResult<byte[]> data = ReadUri(uri);
            if (data.ResultSucceeded == false)
            {
        ...
        public ObixResult<XElement> InvokeUriXml(Uri uri, XElement element)
        {
            ...
            ObixResult<byte[]> response = InvokeUri(uri, request);
            if (response.ResultSucceeded == false)
            {
                return ErrorStack.PushWithObject(GetType(), response,
