...
#pragma warning restore CS0661 // Type defines operator == or operator != but does not override Object.GetHashCode()
    {
        ...
        private static readonly Dictionary<int, string> itemDict = new Dictionary<int, string>()
        { 
        ...
        public static string Message(int result) {
            ObixResult obixResult = kObixClientUnknownError;
            ...
            if (itemDict.ContainsKey(obixResult) == false) {
                if (result == 7)
                {
                    return "Unknown error: " + result + " - Device didn't respond or possible authentication issue?";
                }
